...
function Toast({ visible }: { visible: boolean }) {
  return (
    <div
      className={cn(
        'fixed bottom-6 left-1/2 -translate-x-1/2 z-50 px-4 py-2 rounded-lg bg-foreground text-background text-xs font-medium shadow-lg transition-all duration-300',
    ...
    <>
      <div className={cn(
        ...
        <div className={cn(
          ...
          <button
            onClick={() => fireAndForget('approve', 'approved')}
          ...
          <button
            onClick={() => fireAndForget('request-changes', 'changes_requested')}
          ...
          <button
            onClick={() => fireAndForget('defer', 'deferred')}
